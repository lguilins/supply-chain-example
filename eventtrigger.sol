...
contract ItemManager is Ownable {
    ...
    struct S_Item {
        ...
        string _identifier;
        uint256 _itemPrice;
        ItemManager.SupplyChainStatus _state;
    }
        ...
        onlyOwner
    {
        ...
        items[itemIndex]._state = SupplyChainStatus.Created;
    ...
    function triggerPayment(uint256 _itemIndex) public payable {
        require(
            ...
            "Only full payments allowed"
        );
        require(
            items[_itemIndex]._state == SupplyChainStatus.Created,
            "Item is further in the chain"
        );
        items[_itemIndex]._state = SupplyChainStatus.Paid;
    ...
    function triggerDelivery(uint256 _itemIndex) public payable onlyOwner {
        require(
            items[_itemIndex]._state == SupplyChainStatus.Paid,
            "Item is further in the chain"
        );
        items[_itemIndex]._state = SupplyChainStatus.Delivered;
